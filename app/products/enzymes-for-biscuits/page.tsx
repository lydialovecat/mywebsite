...
const product = products.find((item) => item.slug === "enzymes-for-biscuits")!;

export const metadata: Metadata = {
  title: "Enzymes for Biscuits | Biscuit Enzyme Supplier",
  description:
    "Biscuit enzyme solutions for tough biscuits, crispy biscuits, soda crackers, wafers, cookies, color, crispness, and dough stability.",
  alternates: { canonical: "/products/enzymes-for-biscuits" },
};

export default function BiscuitEnzymePage() {
