...
const product = products.find((item) => item.slug === "bread-moisturizing-enzyme-chf300")!;

export const metadata: Metadata = {
  title: "Bread Moisturizing Enzyme CHF300 | Bread Enzyme Supplier",
  description:
    "CHF300 bread moisturizing enzyme improves softness, moisture retention, dough operability, texture, and shelf-life performance.",
  alternates: { canonical: "/products/bread-moisturizing-enzyme-chf300" },
};

export default function BreadMoisturizingEnzymePage() {
  const schema = {
